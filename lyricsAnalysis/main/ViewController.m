...
//获得歌词数组
- (void)getLrcArray{
    KNAnalyzer *  analyzer = [[KNAnalyzer alloc] init];
...
#pragma mark - ******** 歌词滚动显示
            ...
            //歌词滚动显示
            for ( int i = (int)(weakSelf.lrcArray.count - 1); i >= 0 ;i--) {
                
                
                KNLrcModel * lrc = weakSelf.lrcArray[i];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    KNLrcModel * lrcEach = _lrcArray[indexPath.row];
